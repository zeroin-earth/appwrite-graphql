...
export type Mutation = {
  ...
  accountCreateEmailSession?: Maybe<Session>;
...
export type MutationAccountCreateEmailSessionArgs = {
  email: Scalars['String']['input'];
  password: Scalars['String']['input'];
};
...
export type CreateEmailSessionMutationVariables = Exact<{
  email: Scalars['String']['input'];
  password: Scalars['String']['input'];
}>;


export type CreateEmailSessionMutation = { __typename?: 'Mutation', accountCreateEmailSession?: { __typename?: 'Session', userId?: string | null, expire?: string | null, current?: boolean | null } | null };
