...
export type QueryAccountListIdentitiesArgs = {
  queries: Array<InputMaybe<Scalars['String']['input']>>;
};
...
export type ListIdentitiesQueryVariables = Exact<{
  queries: Array<InputMaybe<Scalars['String']['input']>> | InputMaybe<Scalars['String']['input']>;
}>;
